...
:root{--ai-bg:#0A0906;--ink:#F0EDE6;--ai-muted:rgba(240,237,230,0.45);--ai-accent:#D4600A;--ai-border:rgba(240,237,230,0.08);--ai-glass:rgba(240,237,230,0.03);--forest:#142B22;--D:'Boska',Georgia,serif;--S:'Urbanist',sans-serif;--M:'Instrument Sans',sans-serif}
...
.m-n{font-family:var(--D);font-weight:900;font-size:clamp(3.5rem,7vw,6.5rem);color:var(--ai-accent);line-height:1}
...
@keyframes cursorBlink{0%,100%{border-right-color:var(--ai-accent)}50%{border-right-color:transparent}}
...
.s-label{border-right:2px solid var(--ai-accent);padding-right:6px;animation:cursorBlink 1s step-end infinite;display:inline-block}

/* Link underline */
.pc-link{position:relative}
.pc-link::before{content:'';position:absolute;bottom:-2px;left:0;width:0;height:1px;background:var(--ai-accent);transition:width .4s cubic-bezier(.16,1,.3,1)}
