...
:root{--cp-bg:#0A0906;--cp-white:#F0EDE6;--cp-accent:#0066FF;--cp-muted:rgba(240,237,230,0.45);--cp-border:rgba(240,237,230,0.08);--cp-glass:rgba(240,237,230,0.03);--D:'Comforter',cursive;--S:'Poppins',sans-serif;--M:'Space Mono',monospace}
