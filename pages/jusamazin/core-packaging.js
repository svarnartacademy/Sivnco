...
<section className="cp-s" style={{padding:0}}><div className="cp-gallery">{[
  {id:'hero_lineup',alt:'Hero Lineup',src:'/images/jusamazin/core/hero_lineup.png'},
  {id:'shelf_array',alt:'Shelf Array',src:'/images/jusamazin/core/shelf_array.png'},
  {id:'variant_matrix',alt:'Variant Matrix',src:'/images/jusamazin/core/variant_matrix.png'},
  {id:'label_detail',alt:'Label Detail',src:'/images/jusamazin/core/label_detail.png'},
  {id:'lifestyle',alt:'Lifestyle Shot',src:'/images/jusamazin/core/lifestyle.png'},
  {id:'portfolio',alt:'Full Portfolio',src:'/images/jusamazin/core/portfolio.png'}
].map(g=>(<div key={g.id} className="cp-gal-item cpv" style={{position:'relative',overflow:'hidden'}}><img src={g.src} alt={g.alt} style={{width:'100%',height:'100%',objectFit:'cover',display:'block'}}/></div>))}</div></section>
