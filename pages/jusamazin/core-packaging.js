...
<section className="cp-s"><div className="cp-c"><div className="cp-label cpv">Transformation</div><div className="cp-title cpv">Before<br/><em>and after.</em></div><div className="cp-ba cpv"><div className="cp-ba-side"><div className="cp-ba-tag">Before — Aug 2023 (at joining)</div><p className="cp-ba-text">No unified system. Every SKU looked like it belonged to a different brand. Complete lack of shelf-ready files and zero brand rationale documentation.</p></div><div className="cp-ba-side after"><div className="cp-ba-tag">After — 2023 Onwards</div><p className="cp-ba-text">15+ SKUs bound tightly by programmatic color logic, strict corporate typographic rules, and premium art directed lifestyle photography.</p></div></div></div></section>
