...
:root{--cp-bg:#0A0906;--cp-white:#F0EDE6;--cp-accent:#0066FF;--cp-muted:rgba(240,237,230,0.45);--cp-border:rgba(240,237,230,0.08);--cp-glass:rgba(240,237,230,0.03);--D:'Doto',sans-serif;--S:'Urbanist',sans-serif;--M:'Urbanist',sans-serif}
...
.cp-hero h1{font-family:var(--D);font-weight:900;font-size:clamp(4.5rem,13vw,13rem);line-height:1.05;}.cp-hero h1 span{color:var(--cp-accent)}
...
.cp-title{font-family:var(--D);font-weight:900;font-size:clamp(2.8rem,6vw,6.5rem);line-height:1.05;margin-bottom:2.5rem}.cp-title em{font-style:normal;color:var(--cp-muted);font-family:var(--S);font-weight:300}
...
.cp-pill-card h3{font-family:var(--D);font-weight:900;font-size:clamp(2rem,4vw,4rem);margin-bottom:1.5rem}.cp-pill-card p{font-size:1.05rem;line-height:1.9;color:var(--cp-muted);max-width:520px}
...
.cp-metric-n{font-family:var(--D);font-weight:900;font-size:clamp(3rem,6vw,5.5rem);color:var(--cp-accent);line-height:1}.cp-metric-l{font-family:var(--M);font-size:.5rem;letter-spacing:.15em;color:var(--cp-muted);margin-top:.6rem}
...
.cp-gal-item{background:var(--cp-glass);aspect-ratio:4/3;display:flex;align-items:center;justify-content:center;font-family:var(--D);font-weight:900;font-size:.7rem;letter-spacing:.12em;color:rgba(240,237,230,0.08);transition:background .3s}.cp-gal-item:hover{background:rgba(0,102,255,0.06)}
...
.cp-fb-q{font-size:1rem;line-height:1.85;color:var(--cp-muted);font-style:italic;flex:1}.cp-fb-n{font-family:var(--D);font-weight:900;font-size:1.1rem}.cp-fb-r{font-family:var(--M);font-size:.5rem;letter-spacing:.18em;color:var(--cp-accent);margin-top:.15rem}
.cp-footer{padding:4rem 0 2.5rem;border-top:1px solid var(--cp-border)}
.cp-footer-links{display:flex;flex-wrap:wrap;gap:2rem;margin:2rem 0 3rem}.cp-footer-link{font-family:var(--D);font-weight:900;font-size:clamp(1.4rem,3vw,2.2rem);color:var(--cp-muted);transition:color .3s}.cp-footer-link:hover{color:var(--cp-accent)}
...
const NAV = [{l:'Superfoods',h:'/jusamazin/superfoods'},{l:'Brand Guidelines',h:'/jusamazin/brand-guidelines'},{l:'Bars',h:'/jusamazin/bars'},{l:'Jars',h:'/jusamazin/jars'},{l:'Snacks',h:'/jusamazin/snacks'},{l:'Marketing',h:'/jusamazin/marketing'},{l:'Management',h:'/jusamazin/management'}]
export default function CorePackaging(){return(<>
<Head>
        <link rel="canonical" href="https://sivnco.in/jusamazin/core-packaging" /><meta charSet="UTF-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><title>Core Packaging Range — Sivnco</title><meta name="description" content="Rebuilding a D2C identity system across 15+ SKUs. 176% revenue growth."/><link rel="preconnect" href="https://fonts.googleapis.com"/><link rel="preconnect" href="https://fonts.gstatic.com" crossOrigin="anonymous"/><link href="https://fonts.googleapis.com/css2?family=Doto:wght@100..900&family=Instrument+Sans:ital,wght@0,400..700;1,400..700&family=Urbanist:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet" /><style dangerouslySetInnerHTML={{__html:CSS}}/></Head>
...
<div className="cp-hero"><div className="cp-hero-bg"/><div className="cp-hero-inner"><div className="cp-hero-tag">Master Project / 2023–2026</div><h1>Core<br/><span>Packaging</span><br/>Range<em>Rebuilding a D2C identity system from scratch. 15+ SKUs unified under one visual architecture for unmistakable shelf presence.</em></h1></div></div>
...
<section className="cp-s"><div className="cp-c"><div className="cp-label cpv">Transformation</div><div className="cp-title cpv">Before<br/><em>and after.</em></div><div className="cpv" style={{marginBottom:'2.5rem'}}><ComparisonSlider beforeImage="/images/before/before_jar.jpg" afterImage="/images/jusamazin/bars/amazon_campaign.jpg" beforeLabel="BEFORE: UNLINKED LABELS (AUG 2023)" afterLabel="AFTER: UNIFIED 15+ SKU ARCHITECTURE" aspectRatio="16/9" /></div><div className="cp-ba cpv"><div className="cp-ba-side"><div className="cp-ba-tag">Before — Aug 2023 (at joining)</div><p className="cp-ba-text">No unified system. Every SKU looked like it belonged to a different brand. Complete lack of shelf-ready files and zero brand rationale documentation.</p></div><div className="cp-ba-side after"><div className="cp-ba-tag">After — 2023 Onwards</div><p className="cp-ba-text">15+ SKUs bound tightly by programmatic color logic, strict corporate typographic rules, and premium art directed lifestyle photography.</p></div></div></div></section>
...
<section className="cp-s" style={{padding:0}}><div className="cp-gallery">{[
  {id:'hero_lineup',alt:'Hero Lineup',src:'/images/jusamazin/core/hero_lineup.jpg'},
  {id:'shelf_array',alt:'Shelf Array',src:'/images/jusamazin/core/shelf_array.jpg'},
  {id:'variant_matrix',alt:'Variant Matrix',src:'/images/jusamazin/core/variant_matrix.jpg'},
  {id:'label_detail',alt:'Label Detail',src:'/images/jusamazin/core/label_detail.jpg'},
  {id:'lifestyle',alt:'Lifestyle Shot',src:'/images/jusamazin/core/lifestyle.jpg'},
  {id:'portfolio',alt:'Full Portfolio',src:'/images/jusamazin/core/portfolio.jpg'}
].map(g=>(<div key={g.id} className="cp-gal-item cpv" style={{position:'relative',overflow:'hidden'}}><img loading="lazy" src={g.src} alt={g.alt} style={{width:'100%',height:'100%',objectFit:'cover',display:'block'}}/></div>))}</div></section>
...
<div className="cp-c"><div className="cp-footer"><div className="cp-label">Explore Systems {'>>>'}</div><div className="cp-footer-links">{NAV.map(n=>(<Link key={n.l} href={n.h} className="cp-footer-link">{n.l}</Link>))}</div><div className="cp-footer-meta"><span>© 2023–2026</span><span>My Journey @ Jus&apos;Amazin</span></div></div></div>
