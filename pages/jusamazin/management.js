...
.mg-gallery{display:grid;grid-template-columns:repeat(3,1fr);gap:1px;background:var(--mg-border)}
...
<section className="mg-s" style={{padding:0}}><div className="mg-gallery">{[
  {id:'factory_blueprint',alt:'Factory Floor Sticker Alignment Blueprint',src:'/images/jusamazin/process/draft_packaging_06.jpg'},
  {id:'fleet_branding',alt:'Fleet & Logistics Branding Verification',src:'/images/jusamazin/process/proof_print_01.jpg'},
  {id:'consumer_testing',alt:'Field Consumer Tasting Study & Feedback Notes',src:'/images/jusamazin/process/draft_packaging_03.jpg'},
  {id:'creative_ideation',alt:'Creative Direction & Claim Architecture Sketches',src:'/images/jusamazin/process/draft_packaging_05.jpg'},
  {id:'retail_canopy',alt:'Retail Exhibition Canopy & Architecture',src:'/images/jusamazin/process/retail_trial_04.jpg'},
  {id:'pantone_calibration',alt:'Industrial Print Proofing & Pantone Color Calibration',src:'/images/jusamazin/desi_bar/pantone_proofing.jpg'}
].map(g=>(<div key={g.id} className="mg-gal-item mgv" style={{position:'relative',overflow:'hidden'}}><img loading="lazy" src={g.src} alt={g.alt} style={{width:'100%',height:'100%',objectFit:'cover',display:'block'}}/></div>))}</div></section>
<div className="mg-c"><div className="mg-footer"><div className="mg-label">Master Governance Index {'>>>'}</div><div className="mg-footer-links">{NAV.map(n=>(<Link key={n.l} href={n.h} className="mg-footer-link">{n.l}</Link>))}</div><div className="mg-footer-meta"><span>© 2023–2026</span><span>My Journey @ Jus&apos;Amazin</span></div></div></div>
