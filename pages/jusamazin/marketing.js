...
<section className="mk-s" style={{padding:0}}><div className="mk-gallery">{[
  {id:'video_timeline',alt:'Video Timeline',src:'/images/jusamazin/marketing/video_timeline.png'},
  {id:'color_triage_map',alt:'Color Triage Map',src:'/images/jusamazin/marketing/color_triage_map.png'},
  {id:'amazon_listing',alt:'Amazon Listing',src:'/images/jusamazin/marketing/amazon_listing.png'},
  {id:'blinkit_banner',alt:'Blinkit Banner',src:'/images/jusamazin/marketing/blinkit_banner.png'},
  {id:'competitor_matrix',alt:'Competitor Matrix',src:'/images/jusamazin/marketing/competitor_matrix.png'},
  {id:'final_asset',alt:'Final Asset',src:'/images/jusamazin/marketing/final_asset.png'}
].map(g=>(<div key={g.id} className="mk-gal-item mkv" style={{position:'relative',overflow:'hidden'}}><img src={g.src} alt={g.alt} style={{width:'100%',height:'100%',objectFit:'cover',display:'block'}}/></div>))}</div></section>
