...
.sn-hero h1{font-family:var(--D);font-size:clamp(5rem,14vw,14rem);line-height:1.05;}.sn-hero h1 span{color:var(--sn-accent)}
...
.sn-title{font-family:var(--D);font-size:clamp(2.8rem,6vw,6.5rem);line-height:1.05;margin-bottom:2.5rem}.sn-title em{font-style:normal;color:var(--sn-muted);font-family:var(--S);font-weight:300}
