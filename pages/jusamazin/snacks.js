...
:root{--sn-bg:#0A0906;--sn-white:#F0EDE6;--sn-accent:#D4960A;--sn-blue:#0066FF;--sn-muted:rgba(240,237,230,0.45);--sn-border:rgba(240,237,230,0.08);--sn-glass:rgba(240,237,230,0.03);--D:'Boska',Georgia,serif;--S:'Urbanist',sans-serif;--M:'Instrument Sans',sans-serif}
...
.sn-logo{font-family:var(--D);font-weight:900;font-size:1.3rem;letter-spacing:.08em}.sn-back{font-family:var(--M);font-size:.6rem;letter-spacing:.2em;padding:.55rem 1.4rem;border:1px solid var(--sn-border);border-radius:40px;transition:.3s}.sn-back:hover{border-color:var(--sn-accent);color:var(--sn-accent)}
...
.sn-hero h1{font-family:var(--D);font-weight:900;font-size:clamp(5rem,14vw,14rem);line-height:1.05;}.sn-hero h1 span{color:var(--sn-accent)}
...
.sn-title{font-family:var(--D);font-weight:900;font-size:clamp(2.8rem,6vw,6.5rem);line-height:1.05;margin-bottom:2.5rem}.sn-title em{font-style:normal;color:var(--sn-muted);font-family:var(--S);font-weight:300}
...
.sn-pill-card h3{font-family:var(--D);font-weight:900;font-size:clamp(2rem,4vw,4rem);margin-bottom:1.5rem}.sn-pill-card p{font-size:1.05rem;line-height:1.9;color:var(--sn-muted);max-width:520px}
...
.sn-stack-text h4{font-family:var(--D);font-weight:900;font-size:1.2rem;margin-bottom:.3rem}.sn-stack-text p{font-size:.9rem;color:var(--sn-muted);line-height:1.6}
...
.sn-metric-n{font-family:var(--D);font-weight:900;font-size:clamp(2.5rem,5vw,4.5rem);color:var(--sn-accent);line-height:1;position:relative}.sn-metric-l{font-family:var(--M);font-size:.5rem;letter-spacing:.15em;color:var(--sn-muted);margin-top:.8rem;position:relative;line-height:1.7}
...
.sn-gallery{display:grid;grid-template-columns:repeat(3,1fr);gap:1px;background:var(--sn-border)}.sn-gal-item{background:var(--sn-glass);aspect-ratio:4/3;display:flex;align-items:center;justify-content:center;font-family:var(--D);font-weight:900;font-size:.7rem;letter-spacing:.12em;color:rgba(240,237,230,0.08);transition:background .3s}.sn-gal-item:hover{background:rgba(212,150,10,0.06)}
...
.sn-fb-q{font-size:1rem;line-height:1.85;color:var(--sn-muted);font-style:italic;flex:1}.sn-fb-n{font-family:var(--D);font-weight:900;font-size:1.1rem}.sn-fb-r{font-family:var(--M);font-size:.5rem;letter-spacing:.18em;color:var(--sn-accent);margin-top:.15rem}
.sn-footer{padding:4rem 0 2.5rem;border-top:1px solid var(--sn-border)}.sn-footer-links{display:flex;flex-wrap:wrap;gap:2rem;margin:2rem 0 3rem}.sn-footer-link{font-family:var(--D);font-weight:900;font-size:clamp(1.4rem,3vw,2.2rem);color:var(--sn-muted);transition:color .3s}.sn-footer-link:hover{color:var(--sn-accent)}
