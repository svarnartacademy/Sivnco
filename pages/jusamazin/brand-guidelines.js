...
<section className="bg-s" style={{padding:0}}><div className="bg-gallery">{[
  ...
  {id:'layout_grids',alt:'Layout Grids',src:'/images/jusamazin/guidelines/layout_grids.jpg'}
].map(g=>(<div key={g.id} className="bg-gal-item bgv" style={{position:'relative',overflow:'hidden'}}><img loading="lazy" src={g.src} alt={g.alt} style={{width:'100%',height:'100%',objectFit:'cover',display:'block'}}/></div>))}</div></section>
