...
.sf-hero h1{font-family:var(--D);font-weight:900;font-size:clamp(4.5rem,13vw,13rem);line-height:1.05;}.sf-hero h1 span{color:var(--sf-accent)}
...
.sf-title{font-family:var(--D);font-weight:900;font-size:clamp(2.8rem,6vw,6.5rem);line-height:1.05;margin-bottom:2.5rem}.sf-title em{font-style:normal;color:var(--sf-muted);font-family:var(--S);font-weight:300}
...
.sf-pill-card h3{font-family:var(--D);font-weight:900;font-size:clamp(2rem,4vw,4rem);margin-bottom:1.5rem}.sf-pill-card p{font-size:1.05rem;line-height:1.9;color:var(--sf-muted);max-width:520px}
...
.sf-nut-val{font-family:var(--D);font-weight:900;font-size:clamp(2rem,4vw,3.5rem);color:var(--sf-accent);line-height:1}.sf-nut-label{font-family:var(--M);font-size:.5rem;letter-spacing:.15em;color:var(--sf-muted);margin-top:.5rem}.sf-nut-note{font-family:var(--M);font-size:.4rem;color:var(--sf-red);margin-top:.3rem;letter-spacing:.1em}
...
.sf-gallery{display:grid;grid-template-columns:repeat(3,1fr);gap:1px;background:var(--sf-border)}.sf-gal-item{background:var(--sf-glass);aspect-ratio:4/3;display:flex;align-items:center;justify-content:center;font-family:var(--D);font-weight:900;font-size:.7rem;letter-spacing:.12em;color:rgba(240,237,230,0.08);transition:background .3s}.sf-gal-item:hover{background:rgba(127,140,141,0.06)}
.sf-footer{padding:4rem 0 2.5rem;border-top:1px solid var(--sf-border)}.sf-footer-links{display:flex;flex-wrap:wrap;gap:2rem;margin:2rem 0 3rem}.sf-footer-link{font-family:var(--D);font-weight:900;font-size:clamp(1.4rem,3vw,2.2rem);color:var(--sf-muted);transition:color .3s}.sf-footer-link:hover{color:var(--sf-accent)}
...
@media(max-width:540px){.sf-hero h1{font-size:clamp(2.2rem,11vw,4.2rem)}.sf-s{padding:4rem 0}.sf-soul{padding:5rem 0}.sf-gallery{grid-template-columns:1fr}.sf-nutrition{grid-template-columns:1fr 1fr}}
`
import Navbar from '../../components/Navbar'

const NAV = [{l:'Core Packaging',h:'/jusamazin/core-packaging'},{l:'Brand Guidelines',h:'/jusamazin/brand-guidelines'},{l:'Bars',h:'/jusamazin/bars'},{l:'Jars',h:'/jusamazin/jars'},{l:'Snacks',h:'/jusamazin/snacks'},{l:'Marketing',h:'/jusamazin/marketing'},{l:'Management',h:'/jusamazin/management'}]
export default function Superfoods(){return(<>
<Head>
        <link rel="canonical" href="https://sivnco.in/jusamazin/superfoods" /><meta charSet="UTF-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><title>Superfoods Range — Sivnco</title><meta name="description" content="Technical packaging specification for Jus Amazin Superfoods flexible pouch range."/><link rel="preconnect" href="https://fonts.googleapis.com"/><link rel="preconnect" href="https://fonts.gstatic.com" crossOrigin="anonymous"/><link href="https://fonts.googleapis.com/css2?family=Doto:wght@100..900&family=Instrument+Sans:ital,wght@0,400..700;1,400..700&family=Urbanist:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet" /><style dangerouslySetInnerHTML={{__html:CSS}}/></Head>
...
<section className="sf-s" style={{padding:0}}><div className="sf-gallery">{[
  {id:'pouch_front_500g',alt:'Pouch Front 500g',src:'/images/jusamazin/superfoods/pouch_front_500g.jpg'},
  {id:'pouch_front_oats',alt:'Pouch Front Oats',src:'/images/jusamazin/superfoods/pouch_front_oats.jpg'},
  {id:'seam_detail',alt:'Seam Detail',src:'/images/jusamazin/superfoods/seam_detail.jpg'},
  {id:'typography_macro',alt:'Typography Macro',src:'/images/jusamazin/superfoods/typography_macro.jpg'},
  {id:'pouch_front_flax',alt:'Pouch Front Flax',src:'/images/jusamazin/superfoods/pouch_front_flax.jpg'},
  {id:'shelf_lineup',alt:'Shelf Lineup',src:'/images/jusamazin/superfoods/shelf_lineup.jpg'}
].map(g=>(<div key={g.id} className="sf-gal-item sfv" style={{position:'relative',overflow:'hidden'}}><img loading="lazy" src={g.src} alt={g.alt} style={{width:'100%',height:'100%',objectFit:'cover',display:'block'}}/></div>))}</div></section>
