...
:root{--bg:#0A0906;--ink:#F0EDE6;--muted:rgba(240,237,230,0.45);--accent:#D4600A;--border:rgba(240,237,230,0.08);--glass:rgba(240,237,230,0.03);--forest:#142B22;--D:'Questrial',sans-serif;--S:'Instrument Serif',serif;--M:'Space Mono',monospace}
  ...
  return (
    <>
      <Head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Questrial&family=Instrument+Serif:ital@0;1&family=Space+Mono:wght@400;700&display=swap" rel="stylesheet" />
